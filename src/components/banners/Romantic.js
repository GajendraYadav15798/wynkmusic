    ...
    <>
      <div>
        ...
        >
          ...
          <br />
          <img
            src="https://img.wynk.in/unsafe/250x250/filters:no_upscale():strip_exif():format(webp)/http://s3-ap-south-1.amazonaws.com/wynk-music-cms/srch_universalmusic/music/update/00602448265173_20220715010428321/1657850744/srch_universalmusic_00602448265173-USUM72212957.jpg"
            style={{
              marginTop: "75px",
              height: "395px",
              borderRadius: "25px",
          ...
          <tbody>
            {getData.map((obj, index) => (
              <tr key={index}>
                ...
                <td style={{ color: "gray", paddingLeft: "70px" }}>
                  {obj.artist[0].name}
                </td>
                <td style={{ color: "gray", paddingLeft: "200px" }}>
                  {obj.title}
                </td>
                <td>
                  <button
